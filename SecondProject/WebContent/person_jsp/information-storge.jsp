					...
					<div class="user-info">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								...
								<img class="am-circle am-img-thumbnail" src="../images/dianpu1.png" alt="" />
							</div>

							<p class="am-form-help">我的店铺</p>

							<div class="info-m">
								<div><b>店铺名称：<i>店铺一号</i></b></div>
								<div class="vip">
							...
							<form class="am-form am-form-horizontal">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" placeholder="storename">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" id="user-name2" readonly="true" placeholder="500">
                                         
									</div>
								</div>

								<div class="am-form-group">
									<label class="am-form-label">店铺地址</label>
								...
								<div class="am-form-group">
									<label for="user-phone" class="am-form-label">店铺联系电话</label>
									<div class="am-form-content">
										<input id="user-phone" placeholder="手机号" type="tel">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-click" placeholder="1000" readonly="true" type="email">

									</div>
								</div>
								
								<div class="am-form-group">
									<label for="user-email" class="am-form-label">店铺状态</label>
									<div class="am-form-content"> 
										<select name="店铺状态">

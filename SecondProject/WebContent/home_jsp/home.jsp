			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage shop">
						<div class="menu-hd"><a href="#" target="_top" class="h">免费开店</a></div>
					</div>
				...
				<div class="nav white">
					...
					<div data-toggle="arrowdown" class="search-bar pr">
						...
						<form method="post" action="search.html">
							<input id="searchInput" name="index_none_header_sysc" type="text" placeholder="搜“蛋糕”试试"" autocomplete="off">
			...
			<div class="banner">
                      ...
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								<li class="banner1"><a href="introduction.html"><img src="../images/ad01.jpg" /></a></li>
										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/001.png"></i><a class="ml-22" title="服装">服装内衣</a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		<dt><span title="女装">印记女装</span></dt>
																		<dd><a title="连衣裙" href="#"><span>连衣裙</span></a></dd>
																		<dd><a title="裤子" href="#"><span>裤子</span></a></dd>
																		<dd><a title="小西装" href="#"><span>小西装</span></a></dd>
																		<dd><a title="长袖衬衣" href="#"><span>长袖衬衣</span></a></dd>
																		<dd><a title="春季外套" href="#"><span>春季外套</span></a></dd>
																		<dd><a title="毛衣" href="#"><span>毛衣</span></a></dd>
																		<dd><a title="针织衫" href="#"><span>针织衫</span></a></dd>
																		<dd><a title="长袖T恤" href="#"><span>长袖T恤</span></a></dd>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/002.png"></i><a class="ml-22" title="鞋包配饰">鞋包配饰</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/005.png"></i><a class="ml-22" title="手机数码">手机数码</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/006.png"></i><a class="ml-22" title="家电办公">家电办公</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/010.png"></i><a class="ml-22" title="家居建材">家居建材</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/011.png"></i><a class="ml-22" title="美食特产">美食特产</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/004.png"></i><a class="ml-22" title="珠宝手表">珠宝手表</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/007.png"></i><a class="ml-22" title="护肤彩妆">护肤彩妆</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/009.png"></i><a class="ml-22" title="家纺居家">家纺居家</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li class="appliance js_toggle relative last">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../images/012.png"></i><a class="ml-22" title="日用百货">日用百货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
				...
				<div class="shopMain" id="shopmain">
					...
					<!--<div class="am-container activity ">
						<div class="shopTitle ">
							...
							<h3>发现大家都爱的店</h3>
							<span class="more ">
                              <a href="cake_index.html">全部商家<i class="am-icon-angle-right" style="padding-left:10px ;" ></i></a>
                        </span>
						</div>
                   ...
                   <div class="accordion">
                  	<div class="shopTitle ">
							...
							<h3>发现大家都爱的店</h3>
							<span class="more ">
                              <a href="# ">全部商家<i class="am-icon-angle-right" style="padding-left:10px ;" ></i></a>
                        </span>
						</div>
	<ul>
		<li>
          ...
          <p>店铺描述</p>
					...
					<div class="am-container ">
						<div class="shopTitle ">
							...
							<span class="more ">
                    <a href="# ">更多美衣<i class="am-icon-angle-right" style="padding-left:10px ;" ></i></a>
                        </span>
						</div>
					</div>
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">连衣裙</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">裤子</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">卫衣</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">外套</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">短裙</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">棉袄</b></span></a>									
							</div>
...
<div class="pin">
	<a href="introduction.html"><img src="../images/imgsearch1.jpg " alt="placeholder image" /></a>
	...
	<img src="../images/imgsearch1.jpg " alt="placeholder image" />
	<p class="title fl">手剥松子218g  坚果炒货零食新货巴西松子包邮</p>
											<span class="price fl" style="color: red;">
												<b>¥</b>
												<strong>56.90</strong>
	...
	<p class="title fl">手剥松子218g  坚果炒货零食新货巴西松子包邮</p>
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">手机</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">数码相机</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">笔记本电脑</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">台式机</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">耳机</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">机械键盘</b></span></a>									
							<a class="outer" href="#"><span class="inner"><b class="text">扫地机器人</b></span></a>
							<a class="outer" href="#"><span class="inner"><b class="text">机械键盘</b></span></a>
							<a class="outer" href="#"><span class="inner"><b class="text">机械键盘</b></span></a>
							</div>
							<a href="# ">
...
<div class="pin">
 ...
 <div id="f3">
					...
					<div class="am-g am-g-fixed floodFour">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b class="text">甜品</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">生鲜</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">果蔬</b></span></a>	
								<a class="outer" href="#"><span class="inner"><b class="text">坚果</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">炒货</b></span></a>
								<a class="outer" href="#"><span class="inner"><b class="text">进口零食</b></span></a>									
							</div>
							<a href="# ">

...
<link href="${path}AmazeUI-2.4.2/assets/css/admin2.css" rel="stylesheet" type="text/css">
	...
	<link href="${path}css/personal2.css" rel="stylesheet" type="text/css">
		<link href="${path}css/goodsmanage.css" rel="stylesheet" type="text/css">
...
$.get("${path}Typeservlet",{"op":"parentsname","fatherid": $("#Select1 option:selected").val()},function(mydata,status){
	...
	<form class="form-horizontal"  method="post" action="${path}Goodsservlet?op=addGoods" enctype="multipart/form-data">'
      ...
      <select id="Select3" id="" name="" >
        <option>--请选择--</option>
											...
											商品库存：<input type="text" class="form-control" id="goodsStock" name="goodsStock" style="width:300px;height:35px;" />
												...
												<!-- <div class="form-group"  style="margin-left:225px">
												上传详细图片：<a href="#" id="fileInput"><input type="file"  id="goodsDeImg" name="goodsDeImg" style="width:300px;height:35px;" onchange="showPicture()"/>点这里上传图片</a>
												<img src="" id="img" width="80" height="80" style="display:inline-block;margin-left:50px; ">
												</div> -->
			...
			<aside class="menu">
					...
					<li class="person">
						...
						<ul>
							...
							<li class="active"> <a href="${path}person_jsp/goodsmanage.jsp">商品管理</a></li>

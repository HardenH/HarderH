				...
				<div class="footer">
					...
					<div class="footer-bd">
						<p>
							...
							<a href="#">联系我们</a>
							<a href="#">网站地图</a>
							<em>© 2015-2025 Hengwang.com 版权所有. 更多模板 <a href="http://www.moobnn.com/" target="_blank" title="模板在线">模板在线</a> <a href="http://guantaow.taobao.com" target="_blank">厚朴网络 淘宝店</a> - Collect from <a href="http://www.moobnn.com/" title="模板在线" target="_blank">模板在线</a> <a href="http://guantaow.taobao.com" target="_blank">厚朴网络 淘宝店</a></em>
						</p>
					</div>
				</div>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						...
						<ul>
						<li><a href=" information-storge.jsp">店铺管理</a></li>
						<li> <a href="">商品管理</a></li>
						</ul>
					</li>
					...
					<li class="person">
						<p><i class="am-icon-dollar"></i>钱包管理</p>
						<ul>
							<%-- <li> <a href="points.html">我的积分</a></li> --%>
							<!--<li> <a href="coupon.html">优惠券 </a></li>
							<li> <a href="bonus.html">红包</a></li>-->
							<li> <a href="wallet.jsp">我的钱包</a></li>

...
<%@page import="com.etc.weigo.entity.Goods"%>
<%@page import="java.util.List"%>
<%@page import="com.etc.weigo.service.GoodsService"%>
...
<script type="text/javascript">
	$(function() {
		...
		$("#mc-menu-hd").click(function(){
			...
			if(user_Id != ""){
				location.href = "${path}/home_jsp/shopcart.jsp?user_Id="+user_Id;
			}else{
				location.href = "${path}/home_jsp/login.jsp";
			}
		});
...
<c:if test = "${requestScope.list!=null}">
	...
	<div class="nav white">
		<div class="logo">
			<img src="${patha}/images/logo.png" />
		</div>
		<div class="logoBig">
			<li><img src="${patha}/images/mylogo.png" /></li>
		</div>
	...
	<div class="listMain">
		...
		<div class="scoll">
			...
			<div class="flexslider">
				<ul class="slides">
					<li><img src="${patha}/images/01.jpg" title="pic" /></li>
					<li><img src="${patha}/images/02.jpg" /></li>
					<li><img src="${patha}/images/03.jpg" /></li>
				</ul>
			</div>
			</section>
		</div>
		...
		<div class="item-inform">
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="tb-booth tb-pic tb-s310">
					<a href="${patha}/${goods.GOODSIMG}"><img src="${patha}/${goods.GOODSIMG}" alt="细节展示放大镜特效" rel="${patha}/${goods.GOODSIMG}" class="jqzoom" /></a>
				</div>
				</div>
				<div class="clear"></div>
			</div>
							...
							<div class="theme-popover">
								...
								<div class="theme-popbod dform">
										...
										<div class="theme-signin-right">
											<div class="img-info">
												<img src="${patha}/images/songzi.jpg" />
											</div>
											<div class="text-info">
			...
			<div class="browse">
				<div class="mc">
					<ul>
						...
						<li class="first">
							<div class="p-img">
								<a href="#"> <img class="" src="${patha}/images/browse1.jpg"></a>
							</div>
							<div class="p-name">
						...
						<div class="am-tab-panel am-fade am-in am-active">
							<div class="details">
								...
								<div class="twlistNews">
									...
									<img src="${patha}${goods.GOODSDEIMG}" /> 
								</div>
							</div>
							<div class="clear"></div>
						</div>
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<li>
										<div class="i-pic limit">
											<img src="${patha}/images/imgsearch1.jpg" />
											<p>
		...
		<div id="sidebar">
			<div id="wrap">
					...
					<div class="ibar_login_box status_login">
						<div class="avatar_box">
							<p class="avatar_imgbox">
								<img src="${patha}/images/no-img_mid_.jpg" />
							</p>
							<ul class="user_info">
								<li>用户名：sl1903</li>
								<li>级&nbsp;别：普通会员</li>
				...
				<div id="brand" class="item">
					<a href="#"> <span class="wdsc"><img src="${patha}/images/wdsc.png" /></span></a>
					<div class="mp_tooltip">
				...
				<div id="broadcast" class="item">
					<a href="#"> <span class="chongzhi"><img src="${patha}/images/chongzhi.png" /></span> </a>
					<div class="mp_tooltip">
				...
				<div class="quick_toggle">
					...
					<li class="qtitem">
						...
						<div class="mp_qrcode" style="display: none;">
							<img src="${patha}/images/weixin_code_145.png" /><i

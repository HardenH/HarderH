...
<script type="text/javascript">
		$(function(){
			...
			if(userid != ""){
				$.get("${path}UserServlet",{"op":"searchUserstatebyUserid"},function(mydata,status){
					if(userstate="0"){
					$("#welcome").remove();
					}else{
					$("#please").remove();
			...
			$.get("${path}Goodsservlet",{"op":"searchbycloth"},function(mydata,status){
				...
				$.each(mydata.list,function(index,data){
					...
					$(".pin1").append("<img src='"+data.GOODSIMG+"' alt='placeholder image' />"
			...
			$.get("${path}Goodsservlet",{"op":"searchbyphone"},function(mydata,status){
				...
				$.each(mydata.list,function(index,data){
					...
					$(".pin2").append("<img src='"+data.GOODSIMG+"' alt='placeholder image' />"
							+"<p class='title fl'>"+data.GOODSNAME+"</p>"
							+"<span class='price fl' style='color: red;'>"
							+"<b>¥</b> <strong>"+data.GOODSPRICE+"</strong></span>"
							+"<span class='number fl'>销量<span>"+data.GOODSSALECOUNT+"</span></span>")
	...
	<div class="hmtop">
		...
		<div class="am-container header">
			<ul class="message-l">
				<div class="topMessage">
					<div class="menu-hd">
						<a href="login.jsp" target="_top" class="h" id="please">亲，请登录</a> 
						<a href="register.jsp" target="_top">免费注册</a>
						<a id="wel_user" target="top">欢迎，<span id="welcome">${sessionScope.user_Id}</span></a>
					</div>
				</div>
			</ul>
			<ul class="message-r">
				...
				<div class="topMessage shop">
					<div class="menu-hd">
						<a href="#" target="_top" class="h">免费开店</a>
					</div>
				</div>
		...
		<div class="nav white">
			...
			<div data-toggle="arrowdown" class="search-bar pr">
				...
				<!-- 表单的提交 -->	
				 <form method="post"  action="<%=path%>Goodsservlet?op=searchsomegoods">
													...
													<div class="menu-srot">
														<div class="sort-side">
															<dl class="dl-sort">
																...
																<dd>
																	<a title="小西装" href="#"><span>小西装</span></a>
																</dd>
																<dd>
																	<a title="长袖衬衣" href="#"><span>长袖衬衣</span></a>
																</dd>
																<dd>
																	<a title="春季外套" href="#"><span>春季外套</span></a>
																</dd>
																<dd>
						...
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							<div class="word">
								<a class="outer" href="#"><span class="inner"><b
										class="text">连衣裙</b></span></a> <a class="outer" href="#"><span
									class="inner"><b class="text">裤子</b></span></a> <a class="outer"
									href="#"><span class="inner"><b class="text">卫衣</b></span></a>
								<a class="outer" href="#"><span class="inner"><b
										class="text">外套</b></span></a> <a class="outer" href="#"><span
									class="inner"><b class="text">短裙</b></span></a> <a class="outer"
									href="#"><span class="inner"><b class="text">棉袄</b></span></a>
							</div>
